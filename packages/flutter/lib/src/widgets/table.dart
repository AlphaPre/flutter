...
class _TableElement extends RenderObjectElement {
            ...
            children: row.children
                .map<Element>((Widget child) {
                  return inflateWidget(
                    child,
                    _TableSlot(columnIndex++, rowIndex),
                  );
                })
                .toList(growable: false),
          );
  ...
  void visitChildren(ElementVisitor visitor) {
    for (final Element child in _children.expand<Element>(
      (_TableElementRow row) => row.children,
    )) {
...
class _TableCell extends ParentDataWidget<TableCellParentData> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      EnumProperty<TableCellVerticalAlignment>(
        'verticalAlignment',
        verticalAlignment,
      ),
    );
